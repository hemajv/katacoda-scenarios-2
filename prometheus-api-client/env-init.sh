...
ssh root@host01 "oc process -f ~/generate-metrics.yaml | oc apply -n myproject -f - --as system:admin"
# wait for metrics to be generated
sleep 10
# set up Prometheus
ssh root@host01 "oc process -f ~/deploy-prometheus.yaml | oc apply -n myproject -f - --as system:admin"
